...
TOTP-based MFA, requiring `AuthKitConfig.enable_mfa=True`. Each step is a separate endpoint, authenticated.
...
{
  "secret": "BASE32SECRET...",
  "qr_uri": "otpauth://totp/AuthKit:user@example.com?secret=...&issuer=AuthKit",
