...
authkit is an authentication library — security issues here have outsized
...
1. Go to the [Security tab](https://github.com/awun0105/AuthKit/security) of this repository
...
Out of scope:
- Vulnerabilities in how a consuming application *uses* authkit
