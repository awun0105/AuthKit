...
class TestAuthKitConfig:
  def test_required_secret_key(self):
      """AuthKitConfig requires a secret_key."""
      config = AuthKitConfig(secret_key="my-secret-at-least-32-bytes-long")
      assert config.secret_key == "my-secret-at-least-32-bytes-long"

  def test_defaults(self):
      """AuthKitConfig applies sensible defaults."""
      config = AuthKitConfig(secret_key="test-secret-at-least-32-bytes-long")
  ...
  def test_config_with_oauth_providers(self):
      """AuthKitConfig stores multiple OAuth providers."""
