...
Configure via AuthKitConfig smtp_* fields or pass parameters directly.
"""
...
class SmtpEmailBackend:
  ...
  Usage::
      ...
      # From AuthKitConfig (recommended)
  ...
  @classmethod
  def from_config(cls, config: AuthKitConfig) -> SmtpEmailBackend:
    """Construct an SmtpEmailBackend from a AuthKitConfig instance.
 
    Args:
        config: The application AuthKitConfig.
