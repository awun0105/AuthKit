"""Password hashing and policy enforcement for authkit.

Delegates entirely to pwdlib - never implements custom hashing.
Support argon2 (default) and bcrypt, selectable via AuthKitConfig.
"""
...
from authkit.exceptions import WeakPassword
...
class PasswordHandler:
  ...
  def __init__(self, config: AuthKitConfig) -> None:
    """Initialise with the given AuthKitConfig.
