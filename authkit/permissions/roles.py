"""Role-based access control for authkit."""
from __future__ import annotations

from authkit.exceptions import ForbiddenError
from authkit.models.token import TokenPayload

# Retained AuthWarden JWT ladder for has_min_role/require_min_role.
# Database-backed RBAC does not use this list; consumer roles are data.
