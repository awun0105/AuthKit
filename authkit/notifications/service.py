"""NotificationService — central hub for all authkit notifications.
...
push notifications, webhooks, etc.::
    ...
    auth = AuthKit(..., notification_service=MyNotificationService())
"""
...
from authkit.email.base import AbstractEmailBackend, EmailMessage
from authkit.email.templates import EmailTemplates
from authkit.models.user import UserInDB
from authkit.sms.base import AbstractSmsBackend, SmsMessage
